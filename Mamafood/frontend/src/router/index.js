...
import ChefDashboard from '../components/pages/ChefDashboard.vue';
import Firtpage from '../components/pages/Firstpage.vue';
import ChefFoods from '@/components/pages/ChefFoods.vue';
const routes = [
  {
    path: '/home',
    name: 'Home',
  ...
  },
{
  ...
  { path: '/chefs/:chefId', 
    name: 'ChefFoods', 
    component: ChefFoods, props: true },
