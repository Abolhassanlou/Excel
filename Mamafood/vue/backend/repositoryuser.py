...
class SendEmailVerify:
    ...
    def sendVerify(token:str ): #(token: str, to_email: str):
        ...
        email_password = "sxud gahv ttab ucve" # If you do not have a gmail apps password, create a new app with using generate password. Check your apps and passwords https://myaccount.google.com/apppasswords
